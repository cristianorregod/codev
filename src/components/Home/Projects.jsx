  ...
  return (
    <Container id="projects">
      ...
      <p className="mt-6 text-dark-700 dark:text-dark-200">
        ...
        resultado de mi dedicación y pasión por la programación, y estoy
        encantado de compartirlos contigo. Descubre cómo transformo ideas en
        realidades digitales. ¡Explora, inspira y crea con mis proyectos de
        software!
      </p>
