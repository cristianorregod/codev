...
<br />
De acuerdo con la especificación HTTP, los verbos siempre deben estar en
mayúsculas.
...
<br />
En los ejemplos anteriores, y son ambos sustantivos, que representan una
colección de usuarios y un recurso de usuario específico, respectivamente. Este
diseño de URL hace que las API sean más fáciles de entender y se alinea con los
principios orientados a los recursos RESTful./users/users/123
