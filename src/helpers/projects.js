export const PROJECTS = [
  {
    ...
    content: {
      ...
      technologies: [
        ...
        {
          name: "ReactJS",
          use: "Librería usada para trabajar con JavaScript (Frontend)",
        },
      ],
      features: {
        intro: "",
  ...
  },
  {
    ...
    content: {
      ...
      technologies: [
        ...
        {
          name: "SASS",
          use: "Aplica el diseño visual y responsive del sitio web.",
        },
        {
          name: "ReactJS",
  ...
  },
  {
    ...
    content: {
      ...
      technologies: [
        ...
        {
          name: "NodeJS",
          use: "Desarrollo del backend (Lógica de la aplicación)",
        },
        {
          name: "Express.JS",
      ...
      features: {
        intro:
          "La apllicación al estar conectada con un backend cuenta con diferentes funcones, listaré a continuación algunas de ellas.",
        list: [
  ...
  },
  {
    ...
    content: {
      ...
      features: {
        intro:
          "Estas son algunas de las principales caracerísticas y funcionaldiad del proyecto.",
        list: [
